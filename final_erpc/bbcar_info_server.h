...
#if !defined(_bbcar_info_server_h_)
#define _bbcar_info_server_h_
...
private:
    /*! @brief Server shim for info of BBCarService interface. */
    erpc_status_t info_shim(erpc::Codec * codec, erpc::MessageBufferFactory *messageFactory, uint32_t sequence);
};
